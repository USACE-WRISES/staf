...
2. Function scores roll up to outcome indices (physical, chemical, biological).
3. Physical, Chemical, and Biological Outcome sub-indices are normalized to 0–1 by dividing by 15.
4. The Ecosystem Condition Index is the average of the three indices.

**Function score scale:** 0 to 15. **Outcome index scale:** 0 to 1 (score divided by 15, rounded to 2 decimals).
