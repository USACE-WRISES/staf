...
<!--
  ...
  Canonical source (edit there first, then mirror any change here):
    apps/easi/data/screening-methods.json     bands, breakpoints, input rationale, limitations, basis, sources
    apps/easi/easi/config.py  METRIC_DEFINITIONS    plain-language definition per metric
...
<div class="gfp-charts"><figure class="gfp"><figcaption>Watershed impervious cover (%)</figcaption><div class="gfp-strip"><div class="gfp-seg good"><b>Good</b><span>&lt;10%</span></div><div class="gfp-seg fair"><b>Fair</b><span>10–25%</span></div><div class="gfp-seg poor"><b>Poor</b><span>&gt;25%</span></div></div></figure><figure class="gfp"><figcaption>Watershed agricultural cover (%)</figcaption><div class="gfp-strip"><div class="gfp-seg good"><b>Good</b><span>&lt;25%</span></div><div class="gfp-seg fair"><b>Fair</b><span>25–50%</span></div><div class="gfp-seg poor"><b>Poor</b><span>&gt;50%</span></div></div></figure></div>
</div>
<div class="metric-ref-sec"><div class="metric-ref-label">Breakpoints</div><table class="metric-ref-table"><thead><tr><th>Boundary</th><th>What it marks</th></tr></thead><tbody><tr><td>10% impervious</td><td>Transition from the lower impervious-cover screen to the middle pressure tier.</td></tr><tr><td>25% impervious</td><td>Transition to the upper impervious-cover pressure tier.</td></tr><tr><td>25% agriculture</td><td>Lower national STAF agricultural land-use screening transition.</td></tr><tr><td>50% agriculture</td><td>Upper agricultural land-use screen aligned with NRSA reference-site screening practice.</td></tr></tbody></table></div>
...
<ul class="metric-ref-sources"><li><a href="https://www.epa.gov/system/files/documents/2024-12/nrsa-2018-19-tsd-final-11252024.pdf" target="_blank" rel="noopener noreferrer">National Rivers and Streams Assessment 2018–19 Technical Support Document</a></li></ul>
</div>
</div></details>
...
<div class="metric-ref-sec"><div class="metric-ref-label">Breakpoints</div><table class="metric-ref-table"><thead><tr><th>Boundary</th><th>What it marks</th></tr></thead><tbody><tr><td>1%</td><td>Lower provisional transition separating very low mapped wetland extent from the middle tier.</td></tr><tr><td>5%</td><td>Upper provisional transition to the higher wetland-extent tier.</td></tr></tbody></table></div>
...
<div class="metric-ref-sec"><div class="metric-ref-label">Known limitations</div><ul class="metric-ref-list"><li>Road density does not count actual outfalls or establish whether runoff is treated.</li><li>The 1 km/km² breakpoint is a screening judgment.</li></ul></div>
<div class="metric-ref-sec">
<div class="metric-ref-label">Basis and sources</div>
...
<div class="metric-ref-sec"><div class="metric-ref-label">Good / Fair / Poor</div>
<div class="gfp-charts"><figure class="gfp"><figcaption>Flow alteration, degree of regulation (m³/km²)</figcaption><div class="gfp-strip"><div class="gfp-seg good"><b>Good</b><span>&lt;2%</span></div><div class="gfp-seg fair"><b>Fair</b><span>2–30%</span></div><div class="gfp-seg poor"><b>Poor</b><span>&gt;30%</span></div></div></figure></div>
</div>
<div class="metric-ref-sec"><div class="metric-ref-label">Breakpoints</div><table class="metric-ref-table"><thead><tr><th>Boundary</th><th>What it marks</th></tr></thead><tbody><tr><td>2% DOR</td><td>Onset-of-regulation screening boundary used in comparative river-regulation assessment.</td></tr><tr><td>30% DOR</td><td>Comparative strongly affected boundary; it is not a regulatory standard.</td></tr></tbody></table></div>
...
<ul class="metric-ref-sources"><li><a href="https://www.epa.gov/national-aquatic-resource-surveys/streamcat-metrics-and-definitions" target="_blank" rel="noopener noreferrer">EPA StreamCat Metrics and Definitions</a></li><li><a href="https://www.nature.com/articles/srep06041" target="_blank" rel="noopener noreferrer">Global river regulation and fragmentation classification</a></li></ul>
</div>
</div></details>
...
<div class="metric-ref-sec"><div class="metric-ref-label">Breakpoints</div><table class="metric-ref-table"><thead><tr><th>Boundary</th><th>What it marks</th></tr></thead><tbody><tr><td>25% wetted</td><td>Transition between Poor and Fair where persistent flow is naturally expected.</td></tr><tr><td>75% wetted</td><td>Transition between Fair and Good where persistent flow is naturally expected.</td></tr></tbody></table></div>
<div class="metric-ref-sec"><div class="metric-ref-label">Input rationale</div><ul class="metric-ref-list"><li><b>Wetted channel:</b> The NRSA reach survey directly records the dry-channel fraction; its complement describes wetted-channel continuity during the survey visit.</li><li><b>Expected NHD flow regime:</b> FCODE provides context for natural intermittency but does not itself determine condition. <span class="metric-ref-flag">context only</span></li></ul></div>
...
<div class="metric-ref-sec"><div class="metric-ref-label">Known limitations</div><ul class="metric-ref-list"><li>This is an unstratified confinement/access screen.</li><li>Naturally confined valley settings require field interpretation.</li></ul></div>
<div class="metric-ref-sec">
<div class="metric-ref-label">Basis and sources</div>
<p class="metric-ref-meta">Basis: published threshold &middot; Data confidence: Moderate</p>
<ul class="metric-ref-sources"><li><a href="https://stream-mechanics.com/wp-content/uploads/2020/10/CSQT-v1_Science-Document-1.pdf" target="_blank" rel="noopener noreferrer">Colorado Stream Quantification Tool v1.0 Science Document</a></li></ul>
...
<p class="metric-ref-def">Potential for surface water to exchange with the shallow subsurface (hyporheic zone), inferred from channel slope and sinuosity.</p>
<div class="metric-ref-sec"><div class="metric-ref-label">Good / Fair / Poor</div>
<div class="gfp-charts"><figure class="gfp"><figcaption>Hyporheic-exchange potential (m/m)</figcaption><div class="gfp-strip"><div class="gfp-seg good"><b>Good</b><span>≥0.60</span></div><div class="gfp-seg fair"><b>Fair</b><span>0.30–&lt;0.60</span></div><div class="gfp-seg poor"><b>Poor</b><span>&lt;0.30</span></div></div></figure></div>
</div>
<div class="metric-ref-sec"><div class="metric-ref-label">Breakpoints</div><table class="metric-ref-table"><thead><tr><th>Boundary</th><th>What it marks</th></tr></thead><tbody><tr><td>V 0.30</td><td>Lower provisional screening transition.</td></tr><tr><td>V 0.60</td><td>Upper provisional screening transition.</td></tr></tbody></table></div>
<div class="metric-ref-sec"><div class="metric-ref-label">Input rationale</div><ul class="metric-ref-list"><li><b>Channel slope:</b> Slope represents vertical hydraulic-gradient potential.</li><li><b>Reach sinuosity:</b> Sinuosity represents lateral and meander-driven exchange potential.</li></ul></div>
<div class="metric-ref-sec"><div class="metric-ref-label">Known limitations</div><ul class="metric-ref-list"><li>Bed permeability, sediment texture, and hydraulic head observations are unavailable.</li><li>Weights, caps, and bands are provisional STAF judgments rather than published ecological thresholds.</li></ul></div>
<div class="metric-ref-sec">
<div class="metric-ref-label">Basis and sources</div>
...
<div class="metric-ref-sec"><div class="metric-ref-label">Input rationale</div><ul class="metric-ref-list"><li><b>Bank-height ratio:</b> BHR is a documented incision and floodplain-disconnection clue used in channel-evolution interpretation.</li><li><b>Entrenchment ratio:</b> ER indicates lateral confinement and access to flood-prone width, another documented clue to adjustment state.</li><li><b>NHD feature classification:</b> A canal/ditch classification is decisive; other FCODEs are neutral and cannot imply stable condition. <span class="metric-ref-flag">context only</span></li></ul></div>
...
<p class="metric-ref-def">Potential for excess sediment from watershed sources (cropland, roads) and channel banks relative to natural supply.</p>
<div class="metric-ref-sec"><div class="metric-ref-label">Good / Fair / Poor</div>
<div class="gfp-charts"><figure class="gfp"><figcaption>Sediment-supply potential (%)</figcaption><div class="gfp-strip"><div class="gfp-seg good"><b>Good</b><span>&lt;0.33</span></div><div class="gfp-seg fair"><b>Fair</b><span>0.33–&lt;0.66</span></div><div class="gfp-seg poor"><b>Poor</b><span>≥0.66</span></div></div></figure></div>
</div>
<div class="metric-ref-sec"><div class="metric-ref-label">Breakpoints</div><table class="metric-ref-table"><thead><tr><th>Boundary</th><th>What it marks</th></tr></thead><tbody><tr><td>V 0.33</td><td>Lower provisional combined-pressure transition.</td></tr><tr><td>V 0.66</td><td>Upper provisional combined-pressure transition.</td></tr></tbody></table></div>
<div class="metric-ref-sec"><div class="metric-ref-label">Input rationale</div><ul class="metric-ref-list"><li><b>Agricultural cover:</b> Agriculture represents the dominant disturbed upland sediment-source pathway.</li><li><b>Soil erodibility K-factor:</b> K-factor represents inherent soil erodibility.</li><li><b>Road density:</b> Roads are both a sediment source and a hillslope-to-channel connectivity pathway.</li></ul></div>
<div class="metric-ref-sec"><div class="metric-ref-label">Known limitations</div><ul class="metric-ref-list"><li>The inputs are scientifically directional, while weights, caps, and combined breakpoints are provisional STAF judgments.</li><li>All three inputs are required; missing inputs are not converted to zero.</li></ul></div>
<div class="metric-ref-sec">
<div class="metric-ref-label">Basis and sources</div>
...
<div class="metric-ref-sec"><div class="metric-ref-label">Breakpoints</div><table class="metric-ref-table"><thead><tr><th>Boundary</th><th>What it marks</th></tr></thead><tbody><tr><td>25% embeddedness</td><td>Observed embeddedness transition from Good to Fair.</td></tr><tr><td>75% embeddedness</td><td>Observed embeddedness transition from Fair to Poor.</td></tr></tbody></table></div>
...
<div class="metric-ref-sec"><div class="metric-ref-label">Good / Fair / Poor</div>
<p class="metric-ref-note">Boundaries are the applicable regional reference values; see the breakpoints below.</p>
</div>
...
<p class="metric-ref-def">Physical habitat diversity and cover (pools, riffles, structure, wood) available to aquatic organisms.</p>
<div class="metric-ref-sec"><div class="metric-ref-label">Good / Fair / Poor</div>
<div class="gfp-charts"><figure class="gfp"><figcaption>Habitat-support potential (%)</figcaption><div class="gfp-strip"><div class="gfp-seg good"><b>Good</b><span>≥0.55</span></div><div class="gfp-seg fair"><b>Fair</b><span>0.30–&lt;0.55</span></div><div class="gfp-seg poor"><b>Poor</b><span>&lt;0.30</span></div></div></figure></div>
</div>
<div class="metric-ref-sec"><div class="metric-ref-label">Breakpoints</div><table class="metric-ref-table"><thead><tr><th>Boundary</th><th>What it marks</th></tr></thead><tbody><tr><td>V 0.30</td><td>Lower provisional habitat-support transition.</td></tr><tr><td>V 0.55</td><td>Upper provisional habitat-support transition.</td></tr></tbody></table></div>
<div class="metric-ref-sec"><div class="metric-ref-label">Input rationale</div><ul class="metric-ref-list"><li><b>Woody riparian cover:</b> Woody riparian cover represents potential cover, recruitment, and bank-zone structure.</li><li><b>Reach sinuosity:</b> Sinuosity represents planform and hydraulic variability.</li></ul></div>
<div class="metric-ref-sec"><div class="metric-ref-label">Known limitations</div><ul class="metric-ref-list"><li>This is a low-confidence habitat-support proxy, not a field inventory of pools, wood, cover, or bedforms.</li><li>Weights, caps, and bands are provisional STAF judgments.</li></ul></div>
<div class="metric-ref-sec">
<div class="metric-ref-label">Basis and sources</div>
<p class="metric-ref-meta">Basis: provisional STAF screening judgment &middot; Data confidence: Low &middot; Provisional screening thresholds</p>
<ul class="metric-ref-sources"><li><a href="https://www.epa.gov/caddis/physical-habitat" target="_blank" rel="noopener noreferrer">EPA CADDIS Physical Habitat</a></li></ul>
</div>
</div></details>
...
<div class="metric-ref-sec"><div class="metric-ref-label">Input rationale</div><ul class="metric-ref-list"><li><b>Governing measured condition class:</b> A measured, method-compatible biological condition class is the strongest evidence; when both communities are available, the worse class governs.</li><li><b>Benthic MMI class:</b> Benthic assemblages integrate habitat and water-quality stress over time. <span class="metric-ref-flag">context only</span></li><li><b>Fish MMI class:</b> Fish assemblages integrate habitat, water quality, and longitudinal connectivity. <span class="metric-ref-flag">context only</span></li></ul></div>
...
<div class="metric-ref-label">Basis and sources</div>
<p class="metric-ref-meta">Basis: dataset reference &middot; Data confidence: Moderate</p>
<div class="metric-ref-sub">Automatic source hierarchy</div><ul class="metric-ref-list metric-ref-hierarchy"><li><b>Measured NRSA/state condition class:</b> Use compatible measured benthic and fish classes; the worse class governs and one community is partial.</li><li><b>Published BMMI probability:</b> Use StreamCat prG_BMMI where the reach is inside the published prediction frame.</li><li><b>Published ICI/IWI landscape products:</b> Outside the BMMI prediction frame, calculate the published catchment and watershed integrity products and use the lower value.</li></ul>
...
<div class="metric-ref-sec"><div class="metric-ref-label">Known limitations</div><ul class="metric-ref-list"><li>A successful zero is worded 'no established taxa recorded,' not confirmed absence.</li><li>HUC8 fallback results carry lower confidence than HUC12 results.</li><li>Count bands are STAF screening judgments.</li></ul></div>
<div class="metric-ref-sec">
<div class="metric-ref-label">Basis and sources</div>
...
<ul class="metric-ref-sources"><li><a href="https://nas.er.usgs.gov/" target="_blank" rel="noopener noreferrer">USGS Nonindigenous Aquatic Species database</a></li></ul>
</div>
</div></details>
...
<div class="metric-ref-sec"><div class="metric-ref-label">Known limitations</div><ul class="metric-ref-list"><li>A mapped dam count is a proximity screen and cannot confirm passability or the severity of a barrier.</li><li>NID does not comprehensively represent culverts, smaller structures, or passability.</li><li>Query failure is unscored, not Good.</li></ul></div>
<div class="metric-ref-sec">
<div class="metric-ref-label">Basis and sources</div>
<p class="metric-ref-meta">Basis: dataset reference &middot; Data confidence: Moderate &middot; Provisional screening thresholds</p>
