...
3. Collect intensive field and lab data.
4. Calibrate scoring curves and thresholds.
5. Compute function and outcome scores with uncertainty.
...
- Model Beta (placeholder) - add region, version, and documentation link.

Add new models over time by appending to this list and updating the Resources page with links and citations.

## Downloads / resources
- Detailed tier protocol (placeholder)
- Reference curve templates (placeholder)

## Related methods
- Method E (placeholder)
- Method F (placeholder)
