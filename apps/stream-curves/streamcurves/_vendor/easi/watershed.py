...
STREAMCAT_INPUT_SOURCES = {
    ...
    "substrate.agriculture": "EPA StreamCat crop + hay (watershed)",
...
STREAMCAT_RESULT_SOURCES = {
    ...
    "substrate": "EPA StreamCat agriculture (watershed)",
...
_ENGINE_INPUT_DETAILS = {
    ...
    "substrate.agriculture": "NLCD 2021 crop + hay",
...
_ENGINE_RESULT_DETAILS = {
    ...
    "substrate": "NLCD 2021 agriculture",
