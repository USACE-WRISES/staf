"""Vendor the STAF site computation engine into DEEP.

DEEP's automatic metric pulling runs the engine in-process (apps never import
...
and data) into ``apps/deep/deep/_vendor/site_engine``.
...
Run from anywhere:  python apps/deep/scripts/vendor_site_engine.py
"""
...
DEST = REPO / "apps" / "deep" / "deep" / "_vendor" / "site_engine"
