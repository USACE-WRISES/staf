"""The StreamCat reach for a DEEP site (deep.comid_anchor, 2026-09-07): the
...
from deep import comid_anchor as ca
...
ROUTED = {"anchorKind": "hrSurrogate", "anchorSchemaVersion": 1,
          ...
          # declined past the 10x bound: DEEP reports the ratio and never enforces it
