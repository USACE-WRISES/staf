...
from deep import delineation
from deep.datasources import fabric, flowlines
...
def test_flowlines_fetch_builds_the_layer_from_fabric(monkeypatch):
    ...
    # the name rides along so a covered click's StreamCat reach is named (2026-09-07)
