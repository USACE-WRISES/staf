"""Vendor the STAF site computation engine into SFARI.

SFARI's field-form prefill runs the engine in-process (apps never import
...
and data) into ``apps/sfari/sfari/_vendor/site_engine``.
...
Run from anywhere:  python apps/sfari/scripts/vendor_site_engine.py
"""
...
DEST = REPO / "apps" / "sfari" / "sfari" / "_vendor" / "site_engine"
