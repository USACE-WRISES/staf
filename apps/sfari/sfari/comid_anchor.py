"""The StreamCat lookup engine's reach for a SFARI site.

SFARI snaps every click to the high-resolution NHD and the STAF site engine
...
ratio is reported on every value and never enforced: SFARI ignores the
