/* EASI place/stream search — client-side type-ahead via Photon (Komoot, OSM).
 *
 * Attaches to the #address text input (which lives in the re-rendering Identify
...
(function () {
  ...
  function render(items, input) {
    ...
    items.forEach(function (it) {
      ...
      row.className = "easi-ac-item";
      var name = document.createElement("span");
      name.className = "easi-ac-name";
      name.textContent = it.label;
      var meta = document.createElement("span");
      meta.className = "easi-ac-meta";
