...
draws as a thin line, the STAF site engine delineates the exact watershed at
...
answer covered streams is a question for the score-level equivalence study
(StreamCat inputs against engine inputs at the same sites), not a setting.
...
- **Streams outside the StreamCat network are assessed differently.** Their
  ...
  than from StreamCat, which takes minutes rather than seconds and can refuse a
  ...
  network; the equivalence of the two engines on covered streams is the
