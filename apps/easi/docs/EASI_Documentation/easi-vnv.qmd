...
function scores of 13 / 8 / 3. Current EASI uses 0.90 / 0.55 / 0.10 anchors
and scores of 14 / 8 / 2, with regional reference criteria by default.
The validation results below have not been rerun under that configuration
and do not establish validation of those changes. The current
...
former rating rules with the current anchors.
:::
